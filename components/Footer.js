...
const Footer = () => {
    return (
        <footer className='absolute flex items-center xl:bottom-0 inset-x-0 bottom-20 z-30 w-full text-white xl:px-0 xl:h-[90px]'>
            <div className='mx-auto text-center '>
                
                
                <div className='flex flex-row justify-between text-[12px] xs:text-[8px] gap-2 duration-300 '>
                    ...
                    <div className='flex flex-row lg:text-[8px] text-center items-center justify-end' ><p>|| 2023 M.Asad Bhimjee. All rights reserved. ||</p>
                    </div>
                </div>
