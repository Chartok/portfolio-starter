    ...
    return (
        <footer className='absolute z-30 bottom-0 w-full flex lg:items-center text-white px-8 xl:px-0 xl:h-[90px] pb-5'>
            <div className='container mx-auto text-center '>
                ...
                <div className='text-center justify-center flex flex-row flex-wrap-reverse m-[.8rem] duration-300'>
                    ...
                    <div className='text-sm -m-3 absolute text-center items-center '><p>2023 M.Asad Bhimjee. All rights reserved. </p>
                    </div>
                </div>
